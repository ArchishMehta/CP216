...
cmp     r0, #0
bne     _isLetter       // if r0 is true than instantly return
//=======================================================
// If the char isn't lowercase than check if it's uppercase but still need
// to make sure that the result from isUpperCase is properly passed to r0
bl isUpperCase // test for uppercase
// and this makes it so r0 has the result which is what needs to be returned
//=======================================================
_isLetter:
bx      lr
//-------------------------------------------------------
